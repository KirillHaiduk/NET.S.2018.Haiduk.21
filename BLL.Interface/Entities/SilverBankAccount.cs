...
namespace BLL.Interface.Entities
{
    ...
    public class SilverBankAccount : BankAccount
    {
        ...
        public SilverBankAccount(bool isClosed, int accountNumber, Client owner, decimal balance, double bonusPoints) : base(isClosed, accountNumber, owner, balance, bonusPoints)
        {
        }
